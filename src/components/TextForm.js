...
export default function TextForm(props) {
    ...
    const handleAltClick = ()=>{ 
        ...
        console.log("Alternate text: "+newText);
        setText(newText)
    ...
    const handleInverseClick = ()=>{ 
        ...
        console.log("Inverse text: "+newText);
        setText(newText)
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'#042743'}}> 
            ...
            <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={handleAltClick}>Convert to AltrnatingCase</button>
